-- Drop statements to clean up existing tables
...
DROP TABLE Price_Change CASCADE CONSTRAINTS;
...
CREATE TABLE Price_Change (
    Price_ChangeID integer  NOT NULL,
    CarID integer  NOT NULL,
    Old_Price number(10,4)  NOT NULL,
    New_Price number(10,4)  NOT NULL,
    Change_Date date  NOT NULL,
    CONSTRAINT Price_Change_pk PRIMARY KEY (Price_ChangeID)
) ;
...
-- Reference: Price_Change_Car (table: Price_Change)
ALTER TABLE Price_Change ADD CONSTRAINT Price_Change_Car
    FOREIGN KEY (CarID)
    REFERENCES Car (CarID);
